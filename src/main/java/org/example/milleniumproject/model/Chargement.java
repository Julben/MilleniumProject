...
public class Chargement extends StackPane {
    ...
    public Chargement(Stage primaryStage) {
        ...
        VBox vbox1 = new VBox(20); // Espacement de 20 entre les éléments
        vbox1.getChildren().addAll(messageLabel, comboBox, lancerPartieButton); // Ajouter le label, le ComboBox, et le bouton au VBox
